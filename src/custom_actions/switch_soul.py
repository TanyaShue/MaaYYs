    ...
    def run(self,
        ...
        for count in range(1, 10):
            ...
            if detail is not None:
                ...
                time.sleep(0.5)
                context.run_pipeline("装备御魂", {"装备御魂": {"action": "Click","timeout":500,"recognition": "TemplateMatch","post_delay": 1000,"template": "装备御魂.png","roi": roi,"next": "点击确定"},"点击确定": {"action": "Click","timeout":100,"recognition": "OCR","pre_delay":1000,"expected": "确定","roi": [400,350,475,175]}})
                break
            if count >= 5:
