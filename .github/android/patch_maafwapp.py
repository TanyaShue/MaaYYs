#!/usr/bin/env python3
"""将 MaaFwApp 的 applicationId 基础包名改为 MaaYYs 使用的命名空间。

MaaFwApp 的最终包名是 ``BASE_APPLICATION_ID + "." + pi-profile.yaml 的 app.id``；
本脚本只改基础包名，后缀由 .github/android/pi-profile.yaml 决定。

最终 applicationId: com.maafw.ts + kusa = com.maafw.ts.kusa
"""
...
NEW = 'private const val BASE_APPLICATION_ID = "com.maafw.ts"'
...
def main() -> int:
    ...
    print("Android applicationId base: com.maafw.ts")
    return 0
